...
#
# Usage:
#   python release_generate_resized_images.py
#     --metadata-dir <path_to_metadata_directory>
#     --output-dir <path_to_output_directory>
#   To skip cleaning the output directory, use:
#   python release_generate_resized_images.py --no-clean
#   or set env NO_CLEAN=1
# ---------------------------------------------------------------------------------
import os
import sys
import time
...
SIZES = {
    ...
    "boxart_back.png": [(158, 112), (112, 158), (129, 112)],  # US/EU, JP, 64DD
